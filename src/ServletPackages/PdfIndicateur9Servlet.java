...
public class PdfIndicateur9Servlet extends ConnexionServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			table.addCell(getCell("INDICATOR 9:", PdfPCell.ALIGN_LEFT));
			table.addCell(
					getCell("No of partnership agreements including a 3-5 year cooperation implementation plan,  signed by academic leaders from ACEs and engaged Partner Institutions (→ Outreach/ Regionality)",
							PdfPCell.ALIGN_LEFT));
			...
			table2.addCell(getCell("RECORD OF PARTNERSHIPS ", PdfPCell.ALIGN_CENTER));
			...
			table3.addCell(getCell1("TITLE OF PARTNERSHIP AGREEMENT / MoU"));
			table3.addCell(getCell1("PARTNERS (NAMES AND CONTACT DETAILS) "));
			table3.addCell(cell);
			table3.addCell(getCell1("AREA(S) OF COLLABORATION "));
			table3.addCell(getCell1("SIGNATURE DATE OF PARTNERSHIP AGREEMENT"));
			table3.addCell(getCell1("EXPIRY OF AGREEMENT/ MoU"));
			table3.addCell(getCell1("EXPECTED OUTPUTS/ OUTCOMES"));
			
			table3.addCell(CellSansSpan("NAT"));
			table3.addCell(CellSansSpan("REG"));
			table3.addCell(CellSansSpan("INT"));
//			while (result.next()) {
