...
public class PdfIndicateur10Servlet extends ConnexionServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			table.addCell(getCell("INDICATOR 10:", PdfPCell.ALIGN_LEFT));
			table.addCell(
					getCell("Regular ACE-Programme Implementation team meetings (at least semi-annual) taking place with openly disclosed minutes (on the ACE´s ACE-Progamme Website) (→ Admin./Governance Quality)",
							PdfPCell.ALIGN_LEFT));
			...
			table2.addCell(getCell(" Record of Project Team Meetings ", PdfPCell.ALIGN_CENTER));
			table2.setSpacingAfter(15);
			Table table3 = new Table(10);
			table3.setWidth(100);
			Color couleur = new Color(242, 242, 242);
			table3.addCell(getCell1("REGISTER"));
			table3.addCell(getCell1("Meeting Date."));
			table3.addCell(getCell1("Meeting Type                         EMC/PMC"));
			table3.addCell(getCell1("SURNAME"));
			
			table3.addCell(getCell1("Meeting Time"));
