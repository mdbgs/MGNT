...
public class ProgrammeCEAFormulaireServlet extends GetAuthorisationUsers implements NumericConstant {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		this.doGet(request, response, "responsable_Suivi_Evaluation", "Formulaire/ProgrammeCEA.jsp", connection);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int rs = ComputeQueryBean.insertInAllTable(valueProgramme, "ProgrammeCEA", connection);
