...
public class StageFormulaireServlet extends GetAuthorisationUsers implements NumericConstant{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		this.doGet(req, resp, "responsable_Suivi_Evaluation", "Formulaire/Stage.jsp", connection);
	}
...
//		 dateDeb=dateFormat.format(date);
		try {
			...
			int rs= ComputeQueryBean.insertInAllTable(valueFormation, "Stage",connection);
