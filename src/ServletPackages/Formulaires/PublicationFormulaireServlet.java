...
public class PublicationFormulaireServlet extends GetAuthorisationUsers implements NumericConstant {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    this.doGet(req, resp, "responsable_Suivi_Evaluation", "Formulaire/Publication.jsp", connection);
	}
	/**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int rs= ComputeQueryBean.insertInAllTable(valuePublication, "Publication",connection);
