...
public class GrapheIndicateurActivite extends ConnexionServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		doPost(req, resp);
		this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/OutPut/GrapheIndicateurActivite.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			while (result.next()) {
				listIndicateur.addIndicateurInList(new Indicateur(result.getInt(1), result.getInt(2),
