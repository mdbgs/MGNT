...
public class PdfIndicateur5Servlet extends ConnexionServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			table.addCell(getCell("INDICATOR5:", PdfPCell.ALIGN_LEFT));
			table.addCell(
					getCell("No of regional and national faculty trained by the ACEs (→ Training Quality)",
							PdfPCell.ALIGN_LEFT));
			...
			table3.addCell(CellSansSpan("GENDER"));
			table3.addCell(CellSansSpan("NATIONALITY"));
			table3.addCell(CellSansSpan("REGION"));
			table3.addCell(CellSansSpan("POSITION"));
			table3.addCell(CellSansSpan("INSTITUTIONAL AFFILIATIO N OF FACULTY TRAINED "));
			table3.addCell(CellSansSpan("TITLE & CONTENT OF TRAINING PROGRAMME"));
			table3.addCell(CellSansSpan("INSTITUTION ORGANISING THE TRAINING "));
			table3.addCell(CellSansSpan("NAMES OF TRAINING FACILITATORS AND THEIR INSTIOTUTIONAL AFFILIATIONS "));
			table3.addCell(CellSansSpan("COORDONNEES DES ANIMATEURS "));
//			while (result.next()) {
