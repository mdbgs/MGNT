...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Rechercher" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Affiche 1 to 10 of 57 entrées") DataTables will render large numbers
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": Tri ascendant de la colonne active",
				 ...
				 *    } );
				 */
				"sSortDescending": ": Tri descendant de la colonne active"
			},
			 ...
			 *
			 *  @type string
			 *  @default Affiche _START_ to _END_ of _TOTAL_ entrées
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Affiche page _PAGE_ pour _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Affiche _START_ sur _END_ pour _TOTAL_ entr&eacutees",
			 ...
			 *  @type string
			 *  @default Affiche 0 sur 0 pour 0 entr&eacutees
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "Aucun entr&eacutee affich&eacute"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty": "Affiche 0 sur 0 pour 0 entr&eacutees",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtre pour _MAX_ total entr&eacutees)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Afficher _MENU_ entr&eacutees",
			 ...
			 *    } );
			 */
			/** Commentaire sur la recherche dans le datatable*/
			"sSearch": "",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Ancun enregistrement trouv&eacuteé"
		},
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Affiche x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
