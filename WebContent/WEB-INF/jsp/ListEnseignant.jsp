		...
		<div class="fix main_content_area row ">
			...
			<div class="fix single_sidebar">
								...
								<div class="panel-body">
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody >
												<c:forEach items="${teacherRecu.teacherList}" var="teacher">
													<tr>
														<td><c:out value="${teacher.lastName}"></c:out></td>
														<td><c:out value="${teacher.firstName}"></c:out></td>
														<td><c:out value="${teacher.level}"></c:out></td>
														<td><c:out value="${teacher.adress}"></c:out></td>
													
														<td>
															<button type="submit" class=" btn btn-info"
																id="detailBtn"
																onclick="location.href = 'detail?teacherSending=${teacher.idTeacher}';">
				...
				<input class="btn btn-info myBtnDetail"
					onclick="location.href = 'enseignant';" value="Ajouter" />
