									...
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover"
												...
												<tbody>
													<c:forEach items="${StageRecu.stageList}" var="stage">
														<tr>
															<td><c:out value="${stage.departmentProgram}"></c:out></td>
															<td><c:out value="${stage.startDate}"></c:out></td>
															<td><c:out value="${stage.endDate}"></c:out></td>
															<td><c:out value="${stage.certifcate}"></c:out></td>
															<td>
